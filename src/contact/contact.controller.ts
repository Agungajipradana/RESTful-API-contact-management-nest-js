...
import { Body, Controller, HttpCode, Post } from '@nestjs/common'; // NestJS decorators to define routes and request handling.
...
import { ContactResponse, CreateContactRequest } from '../model/contact.model'; // Models for request and response structures of contacts.
